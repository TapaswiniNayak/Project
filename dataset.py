...
def app():
    new_header = '<p style="font-family:ALGERIAN; color:purple; font-size: 55px;">MOVIE RECOMMENDATION</p>'
    st.markdown(new_header, unsafe_allow_html=True)

    new_rec = '<p style="font-family:Lucida Calligraphy; color:meduimvioletred; font-size: 30px; font-weight: bold;">Your Current Movie Preference?</p>'
